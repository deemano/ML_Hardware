...
parser.add_argument("output_URI", type=str, default="rtp://192.168.0.196:8554", nargs='?', help="URI of the output stream")
parser.add_argument("--network", type=str, default="/usr/local/bin/networks/MonoDepth-FCN-Mobilenet/monodepth_fcn_mobilenet.onnx", help="pre-trained model to load (see below for options)")
